...
public static class PersistenceServiceCollectionExtensions
{
    ...
    public static IHostApplicationBuilder AddPersistence(this IHostApplicationBuilder builder, string serviceName)
    {
        ...
        // The retention lifecycle's adapters. Registered unconditionally like every
        ...
        builder.Services.AddSingleton<StatementDelivery.Crypto.Keys.ICustomerKeyStore, Keys.CustomerKeyRepository>();
